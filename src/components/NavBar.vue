<template>
  <div class="fixed left-0 right-0 z-50">
    <nav class="relative w-100 px-8 lg:mt-5 mx-5 text-primary font-bold">
      <div
      ...
      >
        <h1 class="font-gaegu font-normal text-[40px]">
          <RouterLink to="/" class="p-4 hover:text-primary-light" @click="closeMenu"
            >Miao</RouterLink
          >
        </h1>
        ...
        >
          ...
          <li class="flex sm:max-md:hidden max-sm:gap-4 max-sm:mt-4 max-sm:pb-4">
            <a
              ...
              ><component
                :is="icon"
                color="fill-primary group-hover:fill-primary-light"
                class="fill-white max-sm:hover:fill-secondary"
            /></a>
          </li>
        </ul>
      </div>
